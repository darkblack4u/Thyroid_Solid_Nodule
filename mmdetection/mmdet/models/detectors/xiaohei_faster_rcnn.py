...
# xiaohei[add]: semantic_head
# xiaohei[add]: init_weights/forward_train/simple_test
# xiaohei[add]: with_semantic
    ...
    def forward_train(self,
        ...
        # xiaohei[add]: network
        # xiaohei[add]: losses['loss_semantic_seg'] = loss_seg
    ...
    def simple_test(self, img, img_metas, proposals=None, rescale=False, train_inference=False):
        ...
        # xiaohei[add]: add netowrk/training
