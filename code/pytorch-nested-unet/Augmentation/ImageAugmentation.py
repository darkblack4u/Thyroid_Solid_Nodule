from Augmentation.images_masks_transform import ImageDataGenerator
import cv2
import pandas as pd
import os
...
class DataAug(object):
    ...
    def DataAugmentation(self, filepathImage, number=100, path=None):
        dataX = glob(filepathImage + '/images/*')
        dataY = glob(filepathImage + '/masks/0/*')
