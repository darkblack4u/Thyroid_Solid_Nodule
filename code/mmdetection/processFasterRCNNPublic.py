...
cfg = Config.fromfile('./configs/faster_rcnn/faster_rcnn_r50_fpn_1x_public.py')
cfg.work_dir = 'logs/faster_rcnn_r50_fpn_1x_public_' + time.strftime("%Y%m%d%H%M", time.localtime()) + '/'
