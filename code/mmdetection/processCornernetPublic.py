...
cfg = Config.fromfile('./configs/cornernet/cornernet_hourglass104_mstest_8x6_210e_public.py')
cfg.work_dir = 'logs/cornernet_hourglass104_mstest_8x6_210e_public_' + time.strftime("%Y%m%d%H%M", time.localtime()) + '/'
