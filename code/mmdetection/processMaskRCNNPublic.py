...
cfg = Config.fromfile('./configs/mask_rcnn/mask_rcnn_r50_fpn_1x_public.py')
cfg.work_dir = 'logs/mask_rcnn_r50_fpn_1x_public_' + time.strftime("%Y%m%d%H%M", time.localtime()) + '/'
