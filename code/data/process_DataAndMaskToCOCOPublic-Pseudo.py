...
#     IMAGE_PATH = ORIGIN_PATH + '/{}'.format(keyword)
    ...
    dataset['images'], dataset['annotations'] = images_annotations_info(IMAGE_PATH, MASK_PATH, keyword, folder_id * 100000, False)
...
with open(ORIGIN_PATH + '/annotations/pseudo_' + 'images2.json', 'w') as outfile:
